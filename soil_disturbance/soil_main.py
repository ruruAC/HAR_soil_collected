...
sys.path.append(os.path.abspath('.'))
sys.path.append('/home/zhangjunru/1104/Trans_szs/dltime-torch-dev/dltime-torch-dev')
...
train_data = []
test_data = []
path = '/home/zhangjunru/1104/Trans_szs/dltime-torch-dev/dltime-torch-dev/soil_disturbance/dataset//'
...
for epoch in range(CFG.epochs):
    ...
    if best_score < score:
        ...
        torch.save(model.state_dict(), f"/home/zhangjunru/1104/outputs/{model_name}_{mode}_{now}_16_32_16.pth")
